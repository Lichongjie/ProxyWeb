...
public enum Configuration {
  ...
  private static final String DEFAULT_PROPERTY_FILE = "proxyweb-default.properties";
  /** The user-specific property file name. */
  private static final String PROPERTY_FILE = "proxyweb.properties";
  /** The singleton maintains all the properties. */
  private static final Properties PROPERTIES = new Properties();

  private static final Properties SQL_PROPERTIES;
  private static final String MYSQL_PROPERTIES_FILE = "mysql.properties";
  ...
  static {
    ...
    String mysqlProperties = PathUtils.concatPath(confDir, MYSQL_PROPERTIES_FILE);
    SQL_PROPERTIES = loadUserProperties(mysqlProperties);
