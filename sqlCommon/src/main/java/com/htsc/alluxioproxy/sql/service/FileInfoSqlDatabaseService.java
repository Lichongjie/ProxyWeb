...
public class FileInfoSqlDatabaseService extends DatabaseService {
   ...
   */
  public static void insertFileInfo(Serializable info) throws DataBaseException {
   ...
   */
  public static FileInfoBean selectFileInfoById(String fileId) throws Exception {
   ...
   */
  public static void updateTranscodeInfo(String fileId) throws DataBaseException {
    try {
   ...
   * @throws DataBaseException if sql.sql error happened
   */
  public static void updateArchiveInfo(String fileId) throws DataBaseException {
    try {
   ...
   * @throws DataBaseException if sql.sql error happened
   */
  public static void updateMoveInfo(String  fileId) throws DataBaseException {
    try {
   ...
   * @throws DataBaseException if sql.sql error happened
   */
  public static void updateUnArchiveInfo(String fileId) throws DataBaseException {
    try {
  ...
  public static Timestamp getTime() {
    try {
      String now = FileInfoSqlDatabaseService.fileInfoDateFormat.format(new Date());
  ...
  public static Timestamp getOriginalTime() {
    try {
   ...
   */
  public static int dayIsUnarchived(String day) {
    try {
      String beginDate = day + " 00:00:00";
      String endDate = day + " 23:59:59";
      Date begin = FileInfoSqlDatabaseService.fileInfoDateFormat.parse(beginDate);
      Date end = FileInfoSqlDatabaseService.fileInfoDateFormat.parse(endDate);
